...
var _default = (0, _helperPluginUtils().declare)((api, options) => {
  ...
  function throwLogicForbidden(path) {
    throw new Error(
      "You are using stricter jsx with no logic. " + path._defaulttype + " was encountered within a jsx element."
    )
  }
  ...
  visitor.CallExpression = function(path) {
    ...
    if (callee.type === 'MemberExpression' && callee.object && callee.object.name === 'React') {
      return;
    }
